 ...
 */
public class EditCustomerDialog implements WebService {
    ...
    public EditCustomerDialog(Customer customer, View v, Context context) {
    ...
    private void findViewById(final AlertDialog dialog, final Customer customer) {
        editView = (View) dialog.findViewById(R.id.edit_customer_view);

        showProgress = (ProgressBar)dialog.findViewById(R.id.edit_customer_progressBar);

        params.add("customer_id", String.valueOf(customer.getCustomerId()));
        EditTextWatcher.setCustomer(customer);
        System.out.println("Customer: "+ customer);
        final EditText forename = (EditText)dialog.findViewById(R.id.edit_forename);
        ...
        EditText surnname = (EditText)dialog.findViewById(R.id.edit_surname);
        surnname.setText(customer.getSurname());
        ...
        EditText email = (EditText)dialog.findViewById(R.id.edit_email);
        ...
        EditText contact = (EditText)dialog.findViewById(R.id.edit__phone_number);
        contact.setText(customer.getPhoneNumber());
        ...
        EditText city = (EditText)dialog.findViewById(R.id.edit_city);
        ...
        EditText post = (EditText)dialog.findViewById(R.id.edit_post_code);
        post.setText(customer.getPostCode());
        ...
        genderGrp = (RadioGroup) dialog.findViewById(R.id.edit_gender_radioGrp);
        if (customer.getGender().trim().equalsIgnoreCase(MALE))
        {
            gender = (RadioButton) dialog.findViewById(R.id.edit_radioM);
            gender.setText(MALE);
            gender.setSelected(true);
        }
        else
        {
            gender = (RadioButton) dialog.findViewById(R.id.edit_radioF);
        ...
        genderGrp.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (!customer.getGender().trim().equalsIgnoreCase(checkedRadioButton.getText().toString().trim())){
        ...
        Button save = (Button) dialog.findViewById(R.id.edit_button_save);
            ...
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if(obj.getInt("status") == 200){
                        ...
                        updateModel();
                        System.out.println("After1:" + customer);
                        dialog.dismiss();
